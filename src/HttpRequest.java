...
public class HttpRequest {
	...
	public ResponseSignUp responseSignUp;

	StringBuilder content;
	private String newtoken;
	public HttpRequest(String api, Map<String, String> params, String token, String filePath)
...
//			connection.setRequestProperty("Authorization", "Bearer " + token);
		...
		if (filePath != null) {
			this.addFilePart("avatar", filePath);
		}
...
//			assert (rp.message != null && !"".equals(rp.message));
	...
	public ResponseSignUp getResponse() {
		Gson g = new Gson();
		this.responseSignUp = g.fromJson(content.toString(), ResponseSignUp.class);
