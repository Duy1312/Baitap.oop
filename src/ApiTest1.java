...
public class ApiTest1 {
    ...
    public ApiTest1(String host,  String token) throws MalformedURLException, ProtocolException, IOException {
        ...
        params.clear();
        params.put("phonenumber", "0987654312");
        ...
        params.clear();
        params.put("phonenumber", "0942753273");
        params.put("password", "12345678");
...
//
        ...
        params.clear();
        params.put("phonenumber", "987654312");
        params.put("password", "12345678");
        params.put("uuid", "00322049-63c1-4a11-83b0-0f236884fcbb");
        new HttpRequest(api, params, null, null);
...
//
        ...
        params.clear();
        params.put("phonenumber", "0942753261123");
        params.put("password", "12345678");
        params.put("uuid", "00322049-63c1-4a11-83b0-0f236884fcbb");
        new HttpRequest(api, params, null, null);
        ...
        params.clear();
        params.put("phonenumber", "0942753261");
        params.put("password", "128");
        params.put("uuid", "00322049-63c1-4a11-83b0-0f236884fcbb");
        new HttpRequest( api, params, null, null);
        ...
        params.clear();
        params.put("phonenumber", "0942753261");
        params.put("password", "12345678sdfgsdgsdfg");
        params.put("uuid", "00322049-63c1-4a11-83b0-0f236884fcbb");
        new HttpRequest( api, params, null, null);
